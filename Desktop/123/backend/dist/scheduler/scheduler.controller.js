...
const scheduler_event_dto_1 = require("./dto/scheduler-event.dto");
let ScheduleController = class ScheduleController {
    ...
    async update(id, eventDto) {
        const event = await this.scheduleService.updateEvent(parseInt(id), eventDto);
        if (!event) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [scheduler_event_dto_1.ScheduleEventDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], ScheduleController.prototype, "exportSchedule", null);
exports.ScheduleController = ScheduleController = __decorate([
    (0, common_1.Controller)('schedule'),
    (0, common_1.UseGuards)(admin_guard_1.AdminGuard),
    __metadata("design:paramtypes", [scheduler_service_1.ScheduleService])
], ScheduleController);
