...
let UsersController = class UsersController {
    ...
    async findByEmail(email) {
        ...
        if (!user) {
            throw new common_1.BadRequestException('Пользователь с указанным email не найден');
        }
    ...
    async getUserRegistrations(id) {
        const user = await this.usersService.findOne(id);
        return {
            user: new user_response_dto_1.UserResponseDto(user),
            registrations: [],
...
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "getUserRegistrations", null);
